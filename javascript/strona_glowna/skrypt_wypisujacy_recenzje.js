const RECENZJE = [
    ...
    },
    {
        ...
        ocena: 5,
        uzasadnienie:
            "Teatr Ethereal potrafi zaskoczyć! Ostatni spektakl to prawdziwe arcydzieło - nie tylko ze względu na talent aktorów, ale także wspaniałą reżyserię, która poruszała wszystkie nasze zmysły.",
        data: "Sierpień 2020",
        grafika: "pw.png",
    },
    {
        ...
        ocena: 5,
        uzasadnienie:
            "Nigdy wcześniej nie przeżyliśmy tak intensywnego zderzenia ze sztuką. Teatr Ethereal to miejsce, gdzie magia sceny łączy się z głębokimi przesłaniami, kreując niezapomniane chwile.",
        data: "Luty 2020",
        grafika: "kul.png",
    },
    {
        ...
        ocena: 3,
        uzasadnienie:
            "Cieszymy się, że mieliśmy okazję być częścią publiczności Teatru Ethereal. Spektakl był nie tylko widowiskiem dla oczu, ale także podróżą przez różne emocje, które jeszcze długo z nami pozostaną.",
        data: "Maj 2021",
        grafika: "uj.png",
    },
    {
        ...
        ocena: 5,
        uzasadnienie:
            "To był wieczór pełen wzruszeń i rozbawienia! Spektakl w Teatrze Ethereal to nie tylko wybitne umiejętności aktorskie, ale także cudowne poczucie humoru, które sprawiło, że opuszczenie sali było trudne.",
        data: "Styczeń 2021",
        grafika: "uw.png",
    },
    {
        ...
        ocena: 4,
        uzasadnienie:
            "Teatr Ethereal zaskoczył nas swoją innowacyjnością i świeżym spojrzeniem na klasykę. Przekonujące interpretacje oraz nowatorska scenografia sprawiły, że teatralne doświadczenie było pełne niespodzianek.",
        data: "Marzec 2021",
        grafika: "ps.png",
    },
];
